...
function render(variables = {}) {
  ...
  //name
  let your_name = `<div class="name">${variables.name}</div>`;
  if (variables.name == null) {
    your_name = "<div class='name'>First name</div>";
  }
  //last name
  let last_name = `<div class="lastname">${variables.lastname}</div>`;
  if (variables.lastname == null) {
    last_name = "<div class='lastname'>Last name</div>";
  }
